...
from src.neural_network.common.legal_move import pick_prob_top_legal_move, pick_top_legal_move
...
class NNPlayer(Player):
    ...
    def __init__(self, model: Model = None, ckpt_path: str = None, greedy: bool = False) -> None:
    ...
    def select_move(self, fen_board: str) -> Move:
        ...
        if self.greedy:
            ...
            return pick_prob_top_legal_move(fen_board, predictions[0])
